...
<qgis version="3.10.0-A Coruña" simplifyDrawingTol="1" minScale="1e+08" simplifyLocal="1" simplifyAlgorithm="0" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" labelsEnabled="0" styleCategories="AllStyleCategories" maxScale="0" simplifyMaxScale="1">
  ...
  <renderer-v2 symbollevels="1" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{8f7367f4-b9c7-49ba-995a-a8a1c3b0c7b6}">
      <rule symbol="0" filter=" &quot;art&quot;  =  'Gebaeude' " label="Gebäudefüllung" key="{ae18ba9d-f92f-4a20-9c3a-158457c50665}"/>
      <rule symbol="1" filter=" &quot;art&quot; IN ( 'Gewaesser.fliessendes', 'befestigt.Flugplatz', 'Gebaeude',  'Gewaesser.stehendes',  'befestigt.Strasse_Weg', 'befestigt.Trottoir', 'befestigt.Verkehrsinsel',  'befestigt.Wasserbecken')" label="ausgezogen" key="{4d27e9b6-3a69-4b6f-912d-2d1342515337}"/>
    </rules>
    <symbols>
  ...
  <constraints>
    ...
    <constraint field="t_basket" constraints="1" unique_strength="0" notnull_strength="1" exp_strength="0"/>
    <constraint field="t_datasetname" constraints="1" unique_strength="0" notnull_strength="1" exp_strength="0"/>
    <constraint field="t_ili_tid" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="qualitaet" constraints="1" unique_strength="0" notnull_strength="1" exp_strength="0"/>
    <constraint field="art" constraints="1" unique_strength="0" notnull_strength="1" exp_strength="0"/>
    <constraint field="entstehung" constraints="1" unique_strength="0" notnull_strength="1" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="t_id" exp="" desc=""/>
    <constraint field="t_basket" exp="" desc=""/>
    <constraint field="t_datasetname" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" name="t_datasetname" type="field" width="-1"/>
