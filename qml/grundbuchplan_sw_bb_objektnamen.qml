...
<qgis simplifyAlgorithm="0" simplifyDrawingTol="1" minScale="3000" styleCategories="AllStyleCategories" maxScale="1" labelsEnabled="1" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.10.1-A Coruña" hasScaleBasedVisibilityFlag="1" readOnly="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeUnit="Point" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontWeight="50" multilineHeight="1" fontSize="10" fontStrikeout="0" blendMode="0" fontCapitals="0" fieldName="aname" textOpacity="1" fontItalic="1" isExpression="0" fontLetterSpacing="0" fontFamily="Cadastra" useSubstitutions="0" namedStyle="Italic" textColor="0,0,0,255" fontWordSpacing="0">
      ...
      <placement repeatDistanceUnits="MM" fitInPolygonOnly="0" xOffset="0" overrunDistance="0" geometryGenerator="" maxCurvedCharAngleOut="-25" centroidWhole="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" rotationAngle="0" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" geometryGeneratorEnabled="0" layerType="PointGeometry" overrunDistanceUnit="MM" dist="0" quadOffset="4" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" placementFlags="10" offsetType="0" placement="0" yOffset="0" distUnits="MM" preserveRotation="1" offsetUnits="MM" repeatDistance="0"/>
      <rendering obstacleFactor="1" fontMaxPixelSize="10000" obstacle="0" fontLimitPixelSize="0" fontMinPixelSize="3" zIndex="0" maxNumLabels="2000" upsidedownLabels="0" limitNumLabels="0" mergeLines="0" obstacleType="0" minFeatureSize="0" drawLabels="1" scaleMin="0" labelPerPart="0" scaleVisibility="0" displayAll="0" scaleMax="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
