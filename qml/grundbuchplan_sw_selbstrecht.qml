...
<qgis styleCategories="AllStyleCategories" minScale="6000" labelsEnabled="0" maxScale="1" simplifyMaxScale="1" readOnly="0" simplifyDrawingTol="1" version="3.10.0-A Coruña" simplifyLocal="1" simplifyDrawingHints="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1">
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                <Option type="Map" name="customDash">
                  <Option type="bool" value="true" name="active"/>
                  <Option type="QString" value="CASE&#xa;&#x9;WHEN @map_scale > 3000 AND  @map_scale &lt;= 6000 THEN '1.25;0.5'&#xa;&#x9;WHEN @map_scale > 1250 AND  @map_scale &lt;= 3000 THEN '1.8;0.7'&#xa;&#x9;WHEN  @map_scale > 750 AND  @map_scale &lt;= 1250 THEN '2.5;1.0'&#xa;&#x9;WHEN  @map_scale &lt;= 750 THEN '3.6;1.4'&#xa;&#x9;ELSE 0.000000001&#xa;END" name="expression"/>
                  <Option type="int" value="3" name="type"/>
                </Option>
  ...
  <aliases>
    ...
    <alias index="6" field="selbstrecht_von" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="selbstrecht_von" unique_strength="0" constraints="1" notnull_strength="1"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="selbstrecht_von" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="selbstrecht_von"/>
    </columns>
