...
<qgis styleCategories="AllStyleCategories" minScale="3000" labelsEnabled="1" maxScale="1" simplifyMaxScale="1" readOnly="0" simplifyDrawingTol="1" version="3.10.0-A Coruña" simplifyLocal="1" simplifyDrawingHints="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Italic" fontWordSpacing="0" blendMode="0" fieldName="atext" textOrientation="horizontal" fontCapitals="0" fontStrikeout="0" textOpacity="1" multilineHeight="1" isExpression="0" fontUnderline="0" fontKerning="1" textColor="0,0,0,255" previewBkgrdColor="255,255,255,255" fontSizeUnit="Point" fontLetterSpacing="0" fontItalic="1" fontFamily="Cadastra" fontWeight="50" useSubstitutions="0" fontSize="12" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
      ...
      <text-format formatNumbers="0" wrapChar="" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" plussign="0" multilineAlign="3" decimals="3" placeDirectionSymbol="0" autoWrapLength="0" addDirectionSymbol="0"/>
      <placement yOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" priority="5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" rotationAngle="0" repeatDistanceUnits="MM" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" maxCurvedCharAngleOut="-25" placementFlags="10" centroidInside="0" distUnits="MM" maxCurvedCharAngleIn="25" geometryGeneratorType="PointGeometry" dist="0" placement="0" geometryGeneratorEnabled="0" geometryGenerator="" offsetUnits="MM" repeatDistance="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" xOffset="0" centroidWhole="0" overrunDistance="0" overrunDistanceUnit="MM" preserveRotation="0"/>
      <rendering drawLabels="1" obstacleType="0" mergeLines="0" scaleVisibility="0" scaleMax="0" displayAll="0" fontMaxPixelSize="10000" scaleMin="0" obstacle="1" obstacleFactor="1" fontMinPixelSize="3" upsidedownLabels="0" fontLimitPixelSize="0" minFeatureSize="0" maxNumLabels="2000" labelPerPart="0" zIndex="0" limitNumLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option type="Map" name="properties">
            ...
            <Option type="Map" name="Hali">
              <Option type="bool" value="true" name="active"/>
              <Option type="QString" value="&quot;hali&quot;" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
            <Option type="Map" name="LabelRotation">
              <Option type="bool" value="true" name="active"/>
              <Option type="QString" value="(100+&quot;ori&quot;)*0.9" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
            ...
            <Option type="Map" name="Vali">
              <Option type="bool" value="true" name="active"/>
              <Option type="QString" value="&quot;vali&quot;" name="expression"/>
              <Option type="int" value="3" name="type"/>
            </Option>
          </Option>
          <Option type="QString" value="collection" name="type"/>
  ...
  <aliases>
    ...
    <alias index="4" field="atext" name=""/>
  </aliases>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="atext" unique_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="atext"/>
