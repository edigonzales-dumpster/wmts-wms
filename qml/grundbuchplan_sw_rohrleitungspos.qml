...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingHints="0" minScale="3000" simplifyAlgorithm="0" maxScale="1" hasScaleBasedVisibilityFlag="1" version="3.10.0-A Coruña" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" blendMode="0" fontCapitals="0" isExpression="0" fontWeight="50" fontItalic="1" fieldName="betreiber" useSubstitutions="0" fontLetterSpacing="0" textOpacity="1" namedStyle="Italic" textColor="0,0,0,255" multilineHeight="1" fontSize="10" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontWordSpacing="0" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontFamily="Cadastra">
      ...
      <placement fitInPolygonOnly="0" yOffset="0" priority="5" overrunDistance="0" maxCurvedCharAngleOut="-25" overrunDistanceUnit="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" xOffset="0" distUnits="MM" geometryGenerator="" layerType="PointGeometry" offsetUnits="MM" rotationAngle="0" offsetType="0" maxCurvedCharAngleIn="25" repeatDistance="0" placementFlags="10" centroidWhole="0" placement="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" preserveRotation="1" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry" dist="0" repeatDistanceUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" centroidInside="0" distMapUnitScale="3x:0,0,0,0,0,0"/>
        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            ...
            <Option name="Size" type="Map">
              <Option name="active" type="bool" value="true"/>
              <Option name="expression" type="QString" value="CASE&#xa;&#x9;WHEN @map_scale > 3000 AND  @map_scale &lt;= 6000 THEN 4.5*0.88&#xa;&#x9;WHEN @map_scale > 1250 AND  @map_scale &lt;= 3000 THEN 6.3*0.88&#xa;&#x9;WHEN  @map_scale > 750 AND  @map_scale &lt;= 1250 THEN 9*0.88&#xa;&#x9;WHEN  @map_scale &lt;= 750 THEN 12.6*0.88&#xa;&#x9;ELSE 0.000000001&#xa;END"/>
              <Option name="type" type="int" value="3"/>
            </Option>
  ...
  <aliases>
    ...
    <alias index="4" field="betreiber" name=""/>
  </aliases>
  ...
  <constraintExpressions>
    ...
    <constraint field="betreiber" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="betreiber" type="field" hidden="0" width="-1"/>
