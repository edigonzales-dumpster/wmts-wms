...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingHints="0" minScale="3000" simplifyAlgorithm="0" maxScale="1" hasScaleBasedVisibilityFlag="1" version="3.10.0-A Coruña" simplifyDrawingTol="1">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontUnderline="0" blendMode="0" fontCapitals="0" isExpression="0" fontWeight="50" fontItalic="0" fieldName="aname" useSubstitutions="0" fontLetterSpacing="0" textOpacity="1" namedStyle="Roman" textColor="0,0,0,255" multilineHeight="1" fontSize="10" fontKerning="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" fontStrikeout="0" fontWordSpacing="0" textOrientation="horizontal" previewBkgrdColor="255,255,255,255" fontFamily="Cadastra">
